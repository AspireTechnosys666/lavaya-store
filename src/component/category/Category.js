...
const Category = () => {
  ...
  return (
    <div className="flex flex-col w-full h-full bg-white cursor-pointer scrollbar-hide">
      {categoryDrawerOpen && (
        <div className="w-full flex justify-between items-center h-16 px-6 py-4 bg-[#e0015e] text-white border-b border-gray-100">
              ...
              {pages.map((item) => (
                ...
                >
                  <item.icon
                    ...
                    aria-hidden="true"
                  />
                  <p className="inline-flex items-center justify-between ml-2 text-sm font-medium w-full hover:text-[#e0015e]">
                    {item.title}
                  </p>
                </a>
              ))}
