    ...
    <>
      {option === "Dropdown" ? (
        <select
          ...
          className="focus:shadow-none w-1/2 px-2 py-1 form-select outline-none h-10 text-sm focus:outline-none block rounded-md bg-gray-100 border-transparent focus:bg-white border-[#e0015e] focus:border-[#e0015e66] focus:ring focus:ring-[#e0015e85]"
          name="parent"
        >
          {[
            ...new Map(
                  ...
                  (el) =>
                    ...
                    el?._id === vl[att] && (
                      <button
                        ...
                        className={`${
                          Object?.values(selectVariant).includes(vl[att])
                            ? "bg-[#e0015e] text-white mr-2 border-0 rounded-full inline-flex items-center justify-center px-3 py-1 text-xs font-serif mt-2 focus:outline-none"
