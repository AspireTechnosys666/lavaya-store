const myTheme = {
    ...
    // Pagination
    pagination: {
      base: "mt-3 flex flex-col justify-between text-xs sm:flex-row text-gray-600 dark:text-gray-400",
    },
    // TableFooter
    tableFooter: {
    ...
    button: {
      ...
      primary: {
        base: "text-white bg-[#e0015e] border border-transparent",
        active: "active:bg-[#e0015e] hover:bg-[#1fb9db]",
        disabled: "opacity-50 cursor-not-allowed",
      },
      modern: {
